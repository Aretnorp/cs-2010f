 ...
 */
GLfloat vertices[][3] = {{  0,  0, 1.0 },    { 1,  0, 1.0 },
			 {  1,  1, 1.0 },    { 0,  1, 1.0 } };
...
void Draw()
{
  ...
  /*
   *  Draw the square transformed and scaled in Q4
   */  

  /* First draw the Square that is being used in Q4 */
  glTranslatef(1, 1, 0);
  DrawSquare();

  /* Second, draw it as a Rectangle that has been skewed */
  glRotatef(45, 0, 0, 1);
  glScalef(0.5, 2, 0);
  DrawSquare();
